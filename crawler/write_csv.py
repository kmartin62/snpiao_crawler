...
def write_to_csv(car_dict, ads_dict, sellers_dict, eq_dict, flag):
    ...
    with open('../cars.csv', 'a', newline='', encoding='utf-8') as a, open('../ads.csv', 'a', newline='', encoding='utf-8') as c, open(
            '../sellers.csv', 'a', newline='', encoding='utf-8') as s, open('../equipment.csv', 'a', newline='', encoding='utf-8') as e:
